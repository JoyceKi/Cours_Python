...
# 2 soucis à régler avec le fichier test: sur mon système l'interpréteur Python est accessible via la cmd 'py'
# L'encodage UTF-8 n'interprète pas correctement le byte 0xe9, j'utilise l'encodage cp1252
